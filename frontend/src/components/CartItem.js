      ...
      <div className='w-full flex flex-col'>
        ...
        <div className='flex gap-x-2 h-[36px] text-sm'>
          ...
          <div className='flex flex-1 max-w-[100px] items-center h-full border text-primary font-medium'>
            {/*minus-icon*/}
            <div onClick={handleDecrease} className='flex-1 flex justify-center items-center cursor-pointer '>
            <IoMdRemove />
           </div>
           {/*amount*/}
           ...
           {/*add icon*/}
           <div onClick={()=>increaseAmount(id)} className='flex-1 h-full flex justify-center items-center cursor-pointer'  aria-label="Increase item quantity">
             <IoMdAdd />
           </div>
          </div>
          {/*item price*/}
